...
DATASET_PATH = "emognition_final_dataset_windowed.csv"
...
OUTPUT_SUMMARY_PATH = "simulation_results_baseline_windowed.csv"
...
def main():
    ...
    for model_name, df_subjects in subjects_results_all.items():
        filename = f"subjects_results_{model_name.replace(' ', '_')}_windowed.csv"
